<section id="team" class="relative py-16 max-w-[100rem] mx-auto">
  <h2 class="text-center text-3xl md:text-5xl font-extrabold tracking-tight pb-10">НАШЕ ТОВАРИСТВО</h2>
  <div class="md:hidden absolute top-46 flex justify-between w-full">
  ...
  <div id="team-track"
       class="pair-gap mt-6 flex overflow-x-auto no-scrollbar snap-x snap-mandatory px-4 [scroll-padding-left:1rem]
    ...
    <?php
      $team = [
        ...
        ["img" => "/assets/team/Sofia.webp",  "name" => "Софія Багагура",    "role" => "Комунікаційна менеджерка"],
          ...
          <div class="mx-auto w-full max-w-64">
            <div class="img-container">
              <div class="mx-auto w-full aspect-square max-w-42 md:max-w-64 rounded-full p-[10px] bg-gradient-to-br from-rose-200 to-emerald-200">
                <img src="<?= $p['img'] ?>" alt="<?= htmlspecialchars($p['name'], ENT_QUOTES) ?>" class="h-full w-full rounded-full object-cover">
              </div>
            </div>
    ...
    <div class="hidden md:block relative md:col-span-1 md:col-start-7 min-h-[260px]">
    ...
    <div class="hidden md:block relative md:col-span-1 md:col-start-1 min-h-[260px]">
