...
$chaptersBase = 'guidelines';
$categories = [
  'general' => [
    'title' => 'Загальні',
    'items' => [
      'intro'   => ['title' => 'Вступ'],
      'play'   => ['title' => 'Як зіграти?'],
      'class'   => ['title' => 'Гра в класі'],
      'homework'   => ['title' => 'Гра як ДЗ'],
      'repeat'   => ['title' => 'Гра як повторення'],
      'reflection'   => ['title' => 'Рефлексія після гри'],
  ...
  'history' => [
    'title' => 'Історія',
    'items' => [
      'vitovt' => ['title' => 'Велике князівство Литовське'],
      'orsha' => ['title' => 'Битва під Оршею'],
      'danylo' => ['title' => 'Королівство Русь'],
      'khotyn' => ['title' => 'Хотинська битва'],
      'kyiv' => ['title' => 'Господарче і суспільне життя'],
    ],
  ],
  'hrom' => [
    'title' => 'Громадянська освіта',
    'items' => [
      'orlyk' => ['title' => 'Демократія та Конституція'],
      'unr' => ['title' => 'Конфлікти та їхнє подолання'],
      'lesya' => ['title' => 'Ідентичність і самореалізація'],
      'plast' => ['title' => 'Громадські організації'],
    ],
  ],
  'ects' => [
    'title' => 'Бали ЄКТС',
    'items' => [
      'ects'  => ['title' => 'Як отримати?'],
      'program'  => ['title' => 'Програма підвищення кваліфікацій', 'width' => 'max-w-4xl'],
      'registry'  => ['title' => 'Реєстр сертифікатів', 'width' => 'max-w-5xl'],
    ],
  ],
  'about' => [
    'title' => 'Про гру',
    'items' => [
      'experts'  => ['title' => 'Залучені експерти', 'width' => 'max-w-4xl'],
    ],
  ],
];
$heroTitle = "Методичні рекомендації для гри «Нова Традиція»"
?>

<?php require __DIR__ . '/../parts/hero.php'; ?>
<main class="grow" id="mainSection" data-chapters-base="<?=$chaptersBase?>">
  <div class="grid grid-cols-1 md:grid-cols-12 gap-0">
            ...
            <ul class="mt-1 space-y-1">
              <?php foreach (($cat['items'] ?? []) as $itemSlug => $item): ?>
                <li class="category-item"
                  ...
                  <a href="/api/training?slug=<?= rawurlencode($itemSlug) ?>&base=guidelines"
                     ...
                     data-width="<?= htmlspecialchars($item['width'] ?? 'max-w-3xl') ?>">
    ...
    <section id="contentArea" role="main" class="md:col-span-8 lg:col-span-9 xl:col-span-9 min-h-[60vh] bg-white">
      ...
      <article class="mx-auto px-4 sm:px-6 lg:px-8 py-8" id="mainArticle">
        <header>
          <h1 id="contentTitle" class="text-2xl font-bold tracking-tight text-[#678f94]">Вступ</h1>
        </header>
        <div id="contentBody" class="prose max-w-none">
          <?php require __DIR__ . '/../sections/guidelines/intro.php'; ?>
        </div>
      </article>
    </section>
